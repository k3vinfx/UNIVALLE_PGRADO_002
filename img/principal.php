        ...
        <tr>
            ...
            <td>
                <?php if ($r->Entrenada == 1) { ?>
                    <img src="img/lugares.png" alt="Ir Atrás" ></img>
                <?php } else { ?>
                    <img src="cancel.png" alt="Ir Atrás" > 
                <?php } ?>
            </td>

            <td>
                <a href="?c=principal&a=Crud_Aux&Neurona_Id=<?php echo $r->Neurona_Id; ?>"class="btn btn-danger"><i class='fas fa-brain'></i>Entrenar</a>         
            </td>
